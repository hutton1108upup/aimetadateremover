...
export function UsageAllowance(){
  ...
  return <p className="batch-notice" aria-live="polite">Today: {allowance.singleRemaining} free single-image cleans{allowance.batchLimit>0?` · ${allowance.batchRemaining} Pro batch tasks`:""} remaining. Resets 00:00 UTC. <Link prefetch={false} href="/pricing">Plans</Link> · <Link prefetch={false} href="/account/billing">Account billing</Link></p>;
}
