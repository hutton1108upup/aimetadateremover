...
export function LegalPage({ label, h1, lede, sections }: { label: string; h1: string; lede: string; sections: LegalSection[] }) {
  return <InfoPage label={label} h1={h1} lede={lede}>
    <article className="legal-document">
      <p className="legal-version">Version 1.0 draft · Updated <time dateTime="2026-09-17">September 17, 2026</time></p>
      <aside className="legal-summary" aria-label="Publication status"><strong>Draft for review</strong><p>Operator identity and a working contact channel must be confirmed before this document becomes effective.</p></aside>
