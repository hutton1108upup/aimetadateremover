...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <><PublicHeader /><main className="guide-page"><div className="page-container">
    ...
    <article className="editorial-island island">
      ...
      <p>In this workspace, AI Workflow Clean removes supported generation fields from JPEG and PNG files. Privacy Clean removes supported EXIF GPS, capture dates, device IDs, MakerNotes and JPEG thumbnails. It preserves orientation and copyright, and rejects unsupported nested or strip-thumbnail structures. XMP, IPTC and compressed text may still contain private information: review unresolved findings. Full Clean is not available.</p>
