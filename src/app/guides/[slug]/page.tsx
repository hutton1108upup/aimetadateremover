...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <><PublicHeader /><main className="guide-page"><div className="page-container">
    ...
    <article className="editorial-island island">
      ...
      <p>Open the <Link href="/workspace">image workspace</Link>. If you want to keep private capture details or embedded credentials, expand <strong>Cleaning settings</strong> below the tool first. Select <strong>Keep location, capture dates and device details</strong> or <strong>Keep Content Credentials (source and edit history)</strong> as needed. These options are off by default.</p>
