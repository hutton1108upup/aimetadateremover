...
export const metadata: Metadata = { title: "Share feedback", description: "Tell us what you need from AI Metadata Remover. Every question is optional.", robots: { index: false, follow: true } };
