...
export default function Page(){return <><PublicHeader/><main className="workspace-page"><div className="workspace-title"><h1>Your image workspace</h1><p>Add your files once, then inspect, clean, verify, and download a separate copy.</p></div><UnifiedImageWorkspace variant="full" defaultMode="inspect"/></main><PublicFooter/></>}
